...
public interface FtpReply {
   ...
   *
   * @return the timestamp (in milliseconds since the epoch time) when this reply was sent.
   */
  long getSentTime();

  /**
   * Must implement toString to format the reply as described in the RFC. Most important is the
   * handling of multi-line replies.
   *
   ...
   *
   * @return <code>true</code>, if this reply is a positive completion or positive intermediate
   * reply; <code>false</code>, otherwise.
   */
  boolean isPositive();
}
