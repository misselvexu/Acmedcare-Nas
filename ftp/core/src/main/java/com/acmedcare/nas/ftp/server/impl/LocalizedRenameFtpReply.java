...
import com.acmedcare.nas.ftp.server.ftplet.RenameFtpReply;

/**
 * An implementation of <code>RenameFtpReply</code> that is sent when a file or directory is
 * renamed.
 *
...
public class LocalizedRenameFtpReply extends LocalizedFtpReply implements RenameFtpReply {
  ...
  /**
   * Returns the localized reply that contains all details about the rename operation.
   *
   ...
   */
  public static LocalizedRenameFtpReply translate(
