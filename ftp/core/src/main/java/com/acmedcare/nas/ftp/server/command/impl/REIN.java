...
/**
 * <strong>Internal class, do not use directly.</strong> <code>REIN &lt;CRLF&gt;</code><br>
 *
 * <p>This command flushes a USER, without affecting transfers in progress. The server state should
 * otherwise be as when the user first connects.
 *
  ...
  public void execute(
    ...
    session.write(
        LocalizedFtpReply.translate(
            session, request, context, FtpReply.REPLY_220_SERVICE_READY, "REIN", null));
  }
}
