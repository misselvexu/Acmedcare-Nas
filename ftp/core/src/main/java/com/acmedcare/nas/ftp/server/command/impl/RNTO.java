...
import com.acmedcare.nas.ftp.server.impl.LocalizedRenameFtpReply;
 ...
 * RNTO &lt;SP&gt; &lt;pathname&gt; &lt;CRLF&gt;</code><br>
 *
 * <p>This command specifies the new pathname of the file specified in the immediately preceding
...
public class RNTO extends AbstractCommand {
  ...
  public void execute(
    ...
    try {
      ...
      if (toFileStr == null) {
        session.write(
            LocalizedRenameFtpReply.translate(
                session,
                request,
                context,
      ...
      if (frFile.move(toFile)) {
        ...
        LOG.info(
            "File rename from \"{}\" to \"{}\"", logFrFileAbsolutePath, toFile.getAbsolutePath());
      } else {
        session.write(
            LocalizedRenameFtpReply.translate(
                session,
