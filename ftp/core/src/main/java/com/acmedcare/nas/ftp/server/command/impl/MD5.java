 ...
 * MD5 &lt;SP&gt; &lt;pathname&gt; &lt;CRLF&gt;</code><br>
 * <code>MMD5 &lt;SP&gt; &lt;pathnames&gt; &lt;CRLF&gt;</code><br>
 *
 * <p>Returns the MD5 value for a file or multiple files according to draft-twine-ftpmd5-00.txt.
 *
...
public class MD5 extends AbstractCommand {
  ...
  public void execute(
    ...
    if (isMMD5) {
      session.write(
          LocalizedFtpReply.translate(session, request, context, 252, "MMD5", sb.toString()));
    } else {
      session.write(
          LocalizedFtpReply.translate(session, request, context, 251, "MD5", sb.toString()));
    }
  }
