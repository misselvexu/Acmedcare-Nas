 ...
 */
public class LocalizedDataTransferFtpReply extends LocalizedFtpReply
    implements DataTransferFtpReply {

  /** The file or directory that data transfer is related to. */
  private final FtpFile file;

  /** total number of bytes transferred (bytes sent to the client or receivved from the client) */
   ...
   */
  public LocalizedDataTransferFtpReply(
      int code, String message, FtpFile file, long bytesTransferred) {
    super(code, message);
    this.file = file;
  ...
  /**
   * Returns the localized reply that contains all details about the data transfer.
   *
   ...
   */
  public static LocalizedDataTransferFtpReply translate(
