...
/**
 * Spring {@link FactoryBean} which extends {@link ListenerFactory} making it easier to use Spring's
 * standard &lt;bean&gt; tag instead of FtpServer's custom XML tags to configure things.
 *
