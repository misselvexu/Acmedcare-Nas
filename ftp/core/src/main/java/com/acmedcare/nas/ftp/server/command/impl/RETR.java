 ...
 * RETR &lt;SP&gt; &lt;pathname&gt; &lt;CRLF&gt;</code><br>
 *
 * <p>This command causes the server-DTP to transfer a copy of the file, specified in the pathname,
 * to the server- or user-DTP at the other end of the data connection. The status and contents of
...
public class RETR extends AbstractCommand {
    ...
    try {
      ...
      session.write(
          LocalizedFtpReply.translate(
              session, request, context, FtpReply.REPLY_150_FILE_STATUS_OKAY, "RETR", null));
  ...
  public InputStream openInputStream(FtpIoSession session, FtpFile file, long skipLen)
      throws IOException {
    InputStream in;
