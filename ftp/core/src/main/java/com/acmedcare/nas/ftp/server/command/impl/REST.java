...
/**
 * <strong>Internal class, do not use directly.</strong> <code>REST &lt;SP&gt; <marker> &lt;CRLF&gt;
 * </code><br>
 *
 * <p>The argument field represents the server marker at which file transfer is to be restarted.
