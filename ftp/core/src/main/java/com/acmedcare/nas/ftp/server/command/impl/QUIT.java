...
/**
 * <strong>Internal class, do not use directly.</strong> <code>QUIT &lt;CRLF&gt;</code><br>
 *
 * <p>This command terminates a USER and if file transfer is not in progress, the server closes the
 * control connection.
 *
  ...
  public void execute(
    ...
    session.write(
        LocalizedFtpReply.translate(
            ...
            request,
            context,
            FtpReply.REPLY_221_CLOSING_CONTROL_CONNECTION,
            "QUIT",
            null));
