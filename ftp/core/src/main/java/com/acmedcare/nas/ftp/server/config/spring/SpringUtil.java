...
public class SpringUtil {
  ...
  public static Element getChildElement(
      final Element parent, final String ns, final String localName) {
   ...
   */
  public static Object parseSpringChildElement(
  ...
  public static boolean parseBoolean(
      final Element parent, final String attrName, final boolean defaultValue) {
