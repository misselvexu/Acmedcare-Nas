 ...
 * Native File System
 *
 * <p>Allows the manipulation of any file inside a directory
 *
 * @author <a href="mailto:iskp.me@gmail.com">Elve.Xu</a>
 */
public class NativeFileSystem implements FileSystem<File> {
   ...
   *
   * <p>If the root directory does not exists, it will be created
   *
  ...
  public void delete(File file) throws IOException {
    if (file.isDirectory()) {
      Files.walk(file.toPath()) // Walks through all files, except links
          .sorted(
              Comparator
                  .reverseOrder()) // Reverse order, so it deletes from the highest depth to the
          // lowest one
