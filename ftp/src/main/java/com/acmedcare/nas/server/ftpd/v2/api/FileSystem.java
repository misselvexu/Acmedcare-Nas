...
public interface FileSystem<F extends Object> {
   ...
   *
   * <p>The algorithms "MD5", "SHA-1" and "SHA-256" are required to be implemented
   *
   * @param file      The file object
   ...
   *
   * <p>This method should check for file access permissions
   *
   * @param file The file object
   ...
   * @throws java.io.FileNotFoundException When there's no permission to access the file or the file
   *                                       doesn't exist
   * @throws IOException                   When an error occurs
   */
   ...
   *
   * <p>If the file does not exist, creates the file
   *
   * @param file  The file object
