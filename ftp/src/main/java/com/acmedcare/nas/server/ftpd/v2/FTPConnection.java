...
import com.acmedcare.nas.server.ftpd.v2.api.CommandInfo;
import com.acmedcare.nas.server.ftpd.v2.api.CommandInfo.ArgsArrayCommand;
import com.acmedcare.nas.server.ftpd.v2.api.CommandInfo.Command;
import com.acmedcare.nas.server.ftpd.v2.api.CommandInfo.NoArgsCommand;
...
import com.acmedcare.nas.server.ftpd.v2.handler.ConnectionHandler;
import com.acmedcare.nas.server.ftpd.v2.handler.FileHandler;
...
public class FTPConnection implements Closeable {
   ...
   *
   * <p>Initialized by a {@link FTPServer}
   *
   ...
   *
   * <p>Calling this method can result into desynchronization for the connection.
   *
   * <p>Use an {@link UserAuthenticator} for custom file systems.
   *
