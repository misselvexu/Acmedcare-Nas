...
import static com.acmedcare.nas.exts.api.util.ClassLoaderUtils.getCurrentClassLoader;
...
public final class ClassUtils {
  ...
  public static Class forName(String className, boolean initialize) {
    try {
      ...
      throw new NasContextException(e);
    }
  }
   ...
   * @param <T> 对象具体类
   * @return 对象实例
   * @throws NasContextException 没有找到方法，或者无法处理，或者初始化方法异常等
   */
  public static <T> T newInstance(Class<T> clazz) throws NasContextException {
    ...
    } catch (NasContextException e) {
      throw e;
    } catch (Throwable e) {
      throw new NasContextException(e.getMessage(), e);
    }
  }
