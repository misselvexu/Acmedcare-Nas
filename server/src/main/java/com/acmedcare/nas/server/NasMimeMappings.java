...
/**
 * {@link NasMimeMappings}
 *
 * @author <a href="mailto:iskp.me@gmail.com">Elve.Xu</a>
 * @version v1.0 - 27/09/2018.
 */
public class NasMimeMappings {
  ...
  public static final NasMimeMappings DEFAULT = NasMimeMappings.builder().build();

  NasMimeMappings(final Map<String, String> mappings) {
  ...
  public static class Builder {
    ...
    public NasMimeMappings build() {
      return new NasMimeMappings(mappings);
    }
  }
  ...
  public String getMimeType(final String file) {
    ...
    return getMimeTypeByExtension(lower.substring(pos + 1));
  }
