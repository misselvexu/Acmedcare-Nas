package com.acmedcare.nas.common.exception;
...
public class NasException extends RuntimeException {
  ...
  private static final long serialVersionUID = -4951190500057292928L;
   ...
   * @since 1.7
   */
  public NasException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
